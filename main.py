...
# Версия 20 - Новые фреши
DB_NAME = 'delivery_bot_v20.db'
menu_active = True
...
DEFAULT_ITEMS = [
    ...
    ('fresh_drinks', '🥕 Морковный фреш', 'Свежевыжатый сок (250 мл).', 30000, ''),
    ('fresh_drinks', '❤️ Свекольный фреш', 'Свежевыжатый сок (250 мл).', 30000, ''),
    ('fresh_drinks', '🍎🥕 Яблоко + морковь', 'Свежевыжатый микс (250 мл).', 32000, ''),
    ('fresh_drinks', '🍎❤️ Яблоко + свёкла', 'Свежевыжатый микс (250 мл).', 32000, ''),
    ('fresh_drinks', '🥒🍎 Огурец + яблоко', 'Свежевыжатый микс (250 мл).', 32000, ''),
