...
# Версия 21 - Обновленные цены на фреши
DB_NAME = 'delivery_bot_v21.db'
menu_active = True
...
DEFAULT_ITEMS = [
    ...
    # --- ОБНОВЛЕННЫЕ ЦЕНЫ НА ФРЕШИ ---
    ('fresh_drinks', '🍎 Яблочный фреш', 'Свежевыжатый сок (250 мл).', 27000, ''),
    ('fresh_drinks', '🥕 Морковный фреш', 'Свежевыжатый сок (250 мл).', 16000, ''),
    ('fresh_drinks', '❤️ Свекольный фреш', 'Свежевыжатый сок (250 мл).', 16000, ''),
    ('fresh_drinks', '🍎🥕 Яблоко + морковь', 'Свежевыжатый микс (250 мл).', 19000, ''),
    ('fresh_drinks', '🍎❤️ Яблоко + свёкла', 'Свежевыжатый микс (250 мл).', 19000, ''),
    ('fresh_drinks', '🥒🍎 Огурец + яблоко', 'Свежевыжатый микс (250 мл).', 26000, ''),
